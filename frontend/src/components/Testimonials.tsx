...
const reviews = [
  {
    name: "Sarah Jenkins",
    role: "Patient",
    content: "CareConnect AI completely changed how I manage my health. The AI symptom checker was incredibly accurate and saved me hours of waiting.",
    rating: 5,
  ...
  },
  {
    ...
    role: "Patient",
    content: "Scheduling consults and logging vitals through the patient portal is seamless. The interface is beautiful and so easy to use.",
    rating: 5,
